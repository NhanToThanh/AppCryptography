...
public class aesFrm extends javax.swing.JFrame {
    ...
    private void btKeyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btKeyActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Tạo key thành công với 128 bit độ dài ^^","Done",JOptionPane.INFORMATION_MESSAGE);
        }
        else if (cb256.isSelected()){
        aesKeygen.saveKey(256);  
        JOptionPane.showMessageDialog(null, "Tạo key thành công với 256 bit độ dài ^^","Done",JOptionPane.INFORMATION_MESSAGE);
